...
Properties {
	...
	_Color ("test color", COLOR) = (0.5,0.5,0.5,0.5)
}
...
Subshader {
	Tags { "WaterMode"="Refractive" "RenderType"="Opaque"  "LightMode" = "ForwardBase"  }
	Pass {
CGPROGRAM
#pragma vertex vert
...
half4 frag( v2f i ) : SV_Target
{
	...
	return color * float4(i.vertexLighting * 10 + diffuseReflection + specularReflection, 1.0);
}
ENDCG
